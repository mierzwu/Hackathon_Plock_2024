...
def send_email(email:str,access_code:str) -> None: 
    ...
    body = 'Twój personalny kod do wysłania podania o dofinansofanie na zmianę ogrzewania to: '+str(access_code)+' aby go wykorzystać przejdź na stronę: http://192.168.150.162:5500/dofinansowanie/wniosek_formularz.html'
